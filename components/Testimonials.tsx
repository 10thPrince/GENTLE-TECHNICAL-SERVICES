        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div
                    ...
                    <p className="text-slate-600 dark:text-slate-300 mb-8 text-lg font-light leading-relaxed relative z-10">
                        Gentle Technical Services offered honest, professional, and time-saving technical services.</p>
                    <div className="flex items-center gap-4">
                        <div
                            className="size-12 rounded-full bg-slate-100 dark:bg-slate-700 flex items-center justify-center font-bold text-slate-400">
                            PH</div>
                        <div>
                            <p className="font-bold text-slate-900 dark:text-white text-base">Prince H.</p>
                            <p className="text-xs text-primary font-bold uppercase tracking-wide">HomeOwner, Gasabo
                            </p>
                        </div>
                    </div>
                </div>
